...
def main():
    ...
    strategies = [
        ...
        ("Graph Refined Rolling", graph_refined_rolling.get_actions),
        ("Graph Refined Hysteresis", graph_refined_hysteresis.get_actions),
        ("Graph Refined Gamma", graph_refined_gamma.get_actions),
        ("Graph Refined Centrality", graph_refined_centrality.get_actions),
        ("Graph Refined Momentum", graph_refined_momentum.get_actions),
